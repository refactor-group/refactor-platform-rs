...
pub use entity::{
    ...
    oauth_connections, organizations, password_reset_attempts, pipeline_provider, provider, status,
    token_purpose, topic_priority, topic_status, user_invite_status, user_roles, users, users::Role,
    Id,
};
