...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        // proper PostgreSQL schema qualification (refactor_platform.coaching_session_note_images)
        //
        ...
        let create_table_sql =
            "CREATE TABLE IF NOT EXISTS refactor_platform.coaching_session_note_images (
        ...
        let create_index_sql = "CREATE INDEX IF NOT EXISTS coaching_session_note_images_session_idx
            ON refactor_platform.coaching_session_note_images(coaching_session_id)";
        ...
        manager
            .get_connection()
            .execute_unprepared(
                "ALTER TABLE refactor_platform.coaching_session_note_images OWNER TO refactor",
            )
            .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        // Drop the coaching_session_note_images table (this also drops its index and foreign keys)
        manager
            .get_connection()
            .execute_unprepared(
                "DROP TABLE IF EXISTS refactor_platform.coaching_session_note_images",
            )
            .await?;
